...
>
> Current implementation target: **M5B — safe repricing**
...
| 2 — Ledger and controls | M3A, M3C, M3D, M4, M5B | **Active: M5B** | [`03_LEDGER_AND_CONTROLS.md`](03_LEDGER_AND_CONTROLS.md) |
