...
>
> Current implementation target: **M3A**
...
| 2 — Ledger and controls | M3A, M3C, M3D, M4, M5B | **Active: M3A**; M3D blocked on M8A evidence | [`03_LEDGER_AND_CONTROLS.md`](03_LEDGER_AND_CONTROLS.md) |
