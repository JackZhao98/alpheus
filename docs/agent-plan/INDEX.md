...
| User query, Intent, interruption, and confirmation | Architecture frozen; the minimal immutable Conversation/UserRequest contract is implemented, while Intent/PolicyResolution persistence, UI transport and all confirmation state remain required; trading money-confirmation subset is frozen by Delegation | [`USER_INPUT.md`](USER_INPUT.md), [`DELEGATION_POLICY.md`](DELEGATION_POLICY.md) |
