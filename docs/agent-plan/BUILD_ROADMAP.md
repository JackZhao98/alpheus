...
1. retain landed M11 v1.7.1 recovery/Halt commit `0913010`, implement and pass
   v1.8 K0 stop/recovery acceptance, execute only the separately confirmed
   one-share canary, and mark M11 `LANDED`;
