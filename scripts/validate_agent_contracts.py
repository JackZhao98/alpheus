...
CONTRACT_TYPES = {
    ...
    ("alpheus.runtime", "output_validation_receipt.json"): "output_validation_receipt",
    ("alpheus.runtime", "publication_disabled.json"): "artifact_publication_intent",
    ("alpheus.runtime", "record_output_validation_command.json"): "record_output_validation_command",
