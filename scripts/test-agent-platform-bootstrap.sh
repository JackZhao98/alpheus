...
if ! grep -q 'agent-platform migration already applied: 0119_cortex_paper_candidate_review' \
...
printf '{"status":"PASS","probe":"agent-platform-bootstrap","migration_files":119,"ledger_entries":123,"second_execution":"digest-verified-no-ddl-replay"}\n' \
