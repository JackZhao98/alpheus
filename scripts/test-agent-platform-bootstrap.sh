...
if ! grep -q 'agent-platform migration already applied: 0118_cortex_paper_candidate_projection' \
...
printf '{"status":"PASS","probe":"agent-platform-bootstrap","migration_files":118,"ledger_entries":122,"second_execution":"digest-verified-no-ddl-replay"}\n' \
