...
if ! grep -q 'agent-platform migration already applied: 0013_ap2_blob_adapter' \
...
printf '{"status":"PASS","probe":"agent-platform-bootstrap","migrations":17,"second_execution":"digest-verified-no-ddl-replay"}\n' \
