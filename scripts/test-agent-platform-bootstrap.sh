...
if ! grep -q 'agent-platform migration already applied: 0135_cortex_candidate_task_graph_round_prepare' \
...
printf '{"status":"PASS","probe":"agent-platform-bootstrap","migration_files":135,"ledger_entries":139,"second_execution":"digest-verified-no-ddl-replay"}\n' \
