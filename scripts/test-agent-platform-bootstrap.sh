...
if ! grep -q 'agent-platform migration already applied: 0125_cortex_paper_effect_trace' \
...
printf '{"status":"PASS","probe":"agent-platform-bootstrap","migration_files":125,"ledger_entries":129,"second_execution":"digest-verified-no-ddl-replay"}\n' \
