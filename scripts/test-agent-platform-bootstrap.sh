...
if ! grep -q 'agent-platform migration already applied: 0124_cortex_paper_sha256' \
...
printf '{"status":"PASS","probe":"agent-platform-bootstrap","migration_files":124,"ledger_entries":128,"second_execution":"digest-verified-no-ddl-replay"}\n' \
