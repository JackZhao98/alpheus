...
-- 0033 made child Tasks visible in the trace.  A Turn exists while its model
-- call is dispatched, so its label must not claim completion until the
-- durable result is actually committed.
