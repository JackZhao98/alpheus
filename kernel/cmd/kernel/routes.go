...
func (s *server) routes() http.Handler {
	...
	mux.HandleFunc("GET /agent", serveCockpitFile("agent-room.html", "text/html; charset=utf-8"))
	mux.HandleFunc("GET /assets/agent-room.css", serveCockpitFile("agent-room.css", "text/css; charset=utf-8"))
	mux.HandleFunc("GET /assets/agent-room.js", serveCockpitFile("agent-room.js", "application/javascript; charset=utf-8"))
	mux.HandleFunc("GET /agent/console", serveCockpitFile("agent-console.html", "text/html; charset=utf-8"))
	...
	mux.HandleFunc("GET /agent/playground", serveCockpitFile("agent-playground.html", "text/html; charset=utf-8"))
	mux.HandleFunc("GET /assets/agent-playground.css", serveCockpitFile("agent-playground.css", "text/css; charset=utf-8"))
	mux.HandleFunc("GET /assets/agent-playground.js", serveCockpitFile("agent-playground.js", "application/javascript; charset=utf-8"))
	...
	mux.HandleFunc("GET /agent/console/sessions", s.authorizeAgentWeb(s.getAgentConsoleSessions))
