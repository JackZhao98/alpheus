...
type Limits struct {
	...
	HardLimits struct {
		MaxRiskPerTradePct      float64 `yaml:"max_risk_per_trade_pct" json:"max_risk_per_trade_pct"`
		MaxTotalOpenRiskPct     float64 `yaml:"max_total_open_risk_pct" json:"max_total_open_risk_pct"`
